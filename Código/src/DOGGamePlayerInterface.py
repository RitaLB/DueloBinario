...
class DOGPlayerInterface(DogPlayerInterface):
    def __init__(self):
    ...
    def atualizar_casa_branca(self, digito: int, linha: int, coluna: int) -> None:
        images = {
            0: self.zero_azul,
            1: self.um_azul
        }
        self.tabuleiro[linha][coluna].configure(image=images[digito])
        return
